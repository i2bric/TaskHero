...
export default function Index() {
  ...
  const handleToggleTodo = async (id: Id<"todos">) => {
    try {
      ...
      if (result && result.notificationId) {
        await cancelTaskNotification(result.notificationId);
      }
      
      // Show XP gain animation when completing a task
      if (result && result.leveledUp === false) {
        setShowXPGain(true);
      }
  ...
  const handleDeleteTodo = async (id: Id<"todos">) => {
    // Find the todo to get its notification ID
      ...
      { 
        ...
        onPress: async () => {
          try {
            ...
            const notificationId = result?.notificationId || todo?.notificationId;
            if (notificationId) {
