...
const ProgressStats = () => {
  ...
  const historyStats = useQuery(api.history.getHistoryStats);
  
  const activeTodos = todos ? todos.length : 0;
  const completedTodos = historyStats ? historyStats.totalCompleted : 0;
